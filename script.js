...
const sortNameAscBtn = document.querySelector('#sortNameAtoZ');
const sortNameDescBtn = document.querySelector('#sortNameZtoA');
const sortPassedbutton = document.querySelector('#sortbasedonPass');
const sortbasedonClassBtn = document.querySelector('#sortClass');
const sortGenderBtn = document.querySelector('#sortGender');
const sortMarksBtn = document.querySelector('#sortingbasedonMarks');
...
const searchButton = document.querySelector('#studentsearch button');
...
sortPassedbutton.addEventListener('click', () => {
  sortedStudents.sort((a, b) => b.passing - a.passing);
  renderStudents();
});

sortbasedonClassBtn.addEventListener('click', () => {
